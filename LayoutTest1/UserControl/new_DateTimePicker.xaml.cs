...
namespace LayoutTest1
{
	...
	/// </remarks>
	public partial class new_DateTimePicker : UserControl
	{
		...
		public static readonly RoutedEvent DateChangedEvent = EventManager.RegisterRoutedEvent("DateChanged", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(new_DateTimePicker));
		...
		public static readonly RoutedEvent DateFormatChangedEvent = EventManager.RegisterRoutedEvent("DateFormatChanged", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(new_DateTimePicker));

		#endregion

		#region "DependencyProperties"

		public static readonly DependencyProperty DateFormatProperty = DependencyProperty.Register("DateFormat", typeof(string), typeof(new_DateTimePicker), new FrameworkPropertyMetadata("yyyy-MM-dd HH:mm", OnDateFormatChanged));

		public static DependencyProperty MaximumDateProperty = DependencyProperty.Register("MaximumDate", typeof(DateTime), typeof(new_DateTimePicker), new FrameworkPropertyMetadata(Convert.ToDateTime("3000-01-01 00:00"), null, new CoerceValueCallback(CoerceMaxDate)));

		public static DependencyProperty MinimumDateProperty = DependencyProperty.Register("MinimumDate", typeof(DateTime), typeof(new_DateTimePicker), new FrameworkPropertyMetadata(Convert.ToDateTime("1900-01-01 00:00"), null, new CoerceValueCallback(CoerceMinDate)));

		public static readonly DependencyProperty SelectedDateProperty = DependencyProperty.Register("SelectedDate",
			typeof(DateTime), typeof(new_DateTimePicker),
		...
		public static readonly DependencyProperty DateTextIsWrongProperty = DependencyProperty.Register("DateTextIsWrong", typeof(bool), typeof(new_DateTimePicker), new FrameworkPropertyMetadata(false));
		...
		{
			new_DateTimePicker me = (new_DateTimePicker)d;
